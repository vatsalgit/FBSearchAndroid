...
public class MyItemRecyclerViewAdapterEvent extends RecyclerView.Adapter<MyItemRecyclerViewAdapterEvent.ViewHolder> {
    ...
    boolean isFav;
    public List<ResultItem> fav_event=Favorites_Activity.fav_event;

    private final OnListFragmentInteractionListener mListener;

    public MyItemRecyclerViewAdapterEvent(List<ResultItem> resultItemList,OnListFragmentInteractionListener listener,Context context,Boolean isFav) {
        ...
        holder.mFavButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    // fragment is attached to one) that an item has been selected.
                    Gson gson = new Gson();
                    SharedPreferences  mPrefs = mcontext.getSharedPreferences("Favorites_Event",MODE_PRIVATE);
