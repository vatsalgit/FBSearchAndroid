...
public class MyItemRecyclerViewAdapterUser extends RecyclerView.Adapter<MyItemRecyclerViewAdapterUser.ViewHolder> {
    ...
    boolean isFav;
    public List<ResultItem> fav_user=Favorites_Activity.fav_user;



    public MyItemRecyclerViewAdapterUser()
    {
    ...
    public MyItemRecyclerViewAdapterUser(List<ResultItem> resultItemList,OnListFragmentInteractionListener listener,Context context,Boolean isFav) {
        ...
        holder.mFavButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    // fragment is attached to one) that an item has been selected.
                    Gson gson = new Gson();
                    SharedPreferences  mPrefs = mcontext.getSharedPreferences("Favorites_User",MODE_PRIVATE);
